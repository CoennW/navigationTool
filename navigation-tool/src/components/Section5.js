      ...
      <Typography component="div">
        <Box p={3}>
          ...
          <div className={classes.root}>
                <Button name="btn1" value="section13" id="proceed" onClick={handleClickProceed} variant="contained" color="primary">
                    Yes
                </Button>
                <Button name="btn2" style={{marginLeft:'20px'}} value="section6" id="proceed" onClick={handleClickProceed} variant="contained" color="primary">
                    No
                </Button>
           </div>           
        </Box>
